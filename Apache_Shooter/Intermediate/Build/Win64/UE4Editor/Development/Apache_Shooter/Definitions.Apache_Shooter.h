#undef APACHE_SHOOTER_API
#undef APACHE_SHOOTER_VTABLE
...
#define UE_PROJECT_NAME Apache_Shooter
...
#define APACHE_SHOOTER_VTABLE DLLEXPORT_VTABLE
#define APACHE_SHOOTER_API DLLEXPORT
