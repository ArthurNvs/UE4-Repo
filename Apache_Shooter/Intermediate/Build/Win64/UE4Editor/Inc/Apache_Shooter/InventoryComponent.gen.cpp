...
#include "Apache_Shooter/Public/InventoryComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	APACHE_SHOOTER_API UClass* Z_Construct_UClass_UInventoryComponent_NoRegister();
	APACHE_SHOOTER_API UClass* Z_Construct_UClass_UInventoryComponent();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	UPackage* Z_Construct_UPackage__Script_Apache_Shooter();
	APACHE_SHOOTER_API UFunction* Z_Construct_UFunction_UInventoryComponent_AddToInventory();
	APACHE_SHOOTER_API UClass* Z_Construct_UClass_AInventoryActor_NoRegister();
	APACHE_SHOOTER_API UFunction* Z_Construct_UFunction_UInventoryComponent_RemoveFromInventory();
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInventoryComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInventoryComponent_AddToInventory, "AddToInventory" }, // 684997667
		{ &Z_Construct_UFunction_UInventoryComponent_RemoveFromInventory, "RemoveFromInventory" }, // 3418150527
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_CurrentInventory = { "CurrentInventory", nullptr, (EPropertyFlags)0x0010000000020001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInventoryComponent, CurrentInventory), METADATA_PARAMS(Z_Construct_UClass_UInventoryComponent_Statics::NewProp_CurrentInventory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInventoryComponent_Statics::NewProp_CurrentInventory_MetaData)) };
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UInventoryComponent_Statics::NewProp_CurrentInventory_Inner = { "CurrentInventory", nullptr, (EPropertyFlags)0x0000000000020000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_AInventoryActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	IMPLEMENT_CLASS(UInventoryComponent, 3045177931);
	template<> APACHE_SHOOTER_API UClass* StaticClass<UInventoryComponent>()
	{
		return UInventoryComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInventoryComponent(Z_Construct_UClass_UInventoryComponent, &UInventoryComponent::StaticClass, TEXT("/Script/Apache_Shooter"), TEXT("UInventoryComponent"), false, nullptr, nullptr, nullptr);
