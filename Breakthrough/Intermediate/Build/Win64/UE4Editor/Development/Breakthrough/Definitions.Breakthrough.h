#undef BREAKTHROUGH_API
#undef BREAKTHROUGH_VTABLE
...
#define UE_PROJECT_NAME Breakthrough
...
#define BREAKTHROUGH_VTABLE DLLEXPORT_VTABLE
#define BREAKTHROUGH_API DLLEXPORT
